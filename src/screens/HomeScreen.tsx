...
/**
 * STEP LIVE 03 — PROD TARGET REAL CONTROLADO
...
export const HomeScreen = () => {
  const commitSha = "399ac1e (PROD PUSH)"; // This will be the SHA once I commit
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#FFD700', // Yellow background as requested
  },
  center: {
    flex: 1,
  ...
  banner: {
    backgroundColor: '#FF0000', // Red banner
    paddingVertical: 30,
