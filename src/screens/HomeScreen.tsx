...
export const HomeScreen = ({ navigation }: { navigation: any }) => {
  ...
  */
  ...
  // [LOOP FIX] Temporarily disabled to verify if this causes the React #185 storm on Web
  /*
  React.useEffect(() => {
    let isActive = true;
    const runAnimation = () => {
  ...
  return (
    <Container safe style={styles.container}>
      <View style={{ backgroundColor: '#005500', padding: 8, zIndex: 9999, alignItems: 'center' }}>
        <Typography style={{ color: 'white', fontWeight: 'bold' }}>STEP 17 — Animated loops disabled</Typography>
      </View>
